...
export  class Collection {
  ...
  <tr><td  bgcolor="${this.options.nameColor}" color="${getTextColor(this.options.nameColor)}"  align="center" cellpadding="3"><i>${boldText(this.name)}</i></td></tr>
      ${this.fields.map((field,i)=>'<tr><td port='+'"'+i+'"'+' align="left" color="'+getTextColor(this.options.nameColor)+'">'+field.name+': '+field.options.type+'</td></tr>').join('\n\t')}
